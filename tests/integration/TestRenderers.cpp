...
private:
    ...
    static void _addShapes(BraynsTestUtils &utils)
    {
        ...
        auto cube1Rotation = brayns::Quaternion(brayns::math::deg2rad(35.f), brayns::Vector3f(0.f, 1.f, 0.f));
        ...
        auto cube2Rotation = brayns::Quaternion(brayns::math::deg2rad(-35.f), brayns::Vector3f(0.f, 1.f, 0.f));
