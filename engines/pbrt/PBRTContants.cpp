...
const std::string PBRT_INTEGRATORPROP_VISUALIZESTRATEGIES       = "visualizestrategies";
const std::string PBRT_INTEGRATORPROP_VISUALIZEWEIGHTS          = "visualizeweights";
const std::string PBRT_INTEGRATORPROP_LIGHTSAMPLINGSTRATEGY     = "lightsamplestrategy";
...
const std::string PBRT_INTEGRATORPROP_LARGESTEPPROBABILITY      = "largestepprobability";
...
const std::string PBRT_INTEGRATORPROP_PHOTONSPERITERATION       = "photonsperiteration";
const std::string PBRT_INTEGRATORPROP_IMAGEWRITEFREQUENCY       = "imagewritefrequency";
