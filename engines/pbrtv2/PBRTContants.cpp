...
const std::string PBRT_VOLUME_INTEGRATOR_SINGLEFLOURESCENCE     = "singlefluorescence";
const std::string PBRT_VOLUME_INTEGRATOR_SINGLEFLOURESCENCEWL   = "singlefluorescencerwl";
...
const std::string PBRT_SURFACEINTEGRATOR_PROP_GATHERSAMPLES     = "surfGathersamples";
const std::string PBRT_SURFACEINTEGRATOR_PROP_MAXINDIRECTDEPTH  = "surfMaxindirectdepth";
...
const std::string PBRT_SURFACEINTEGRATOR_PROP_CAUSTICPHOTONS    = "surfCausticphotons";
const std::string PBRT_SURFACEINTEGRATOR_PROP_NLIGHTS           = "surfNlights";
const std::string PBRT_SURFACEINTEGRATOR_PROP_MAXSPECULARDEPTH  = "surfMaxspeculardepth";
const std::string PBRT_SURFACEINTEGRATOR_PROP_GLIMIT            = "surfGlimit";
const std::string PBRT_SURFACEINTEGRATOR_PROP_MAXPHOTONDEPTH    = "surfMaxphotondepth";
const std::string PBRT_SURFACEINTEGRATOR_PROP_FINALGATHER       = "surfFinalgather";
const std::string PBRT_SURFACEINTEGRATOR_PROP_MINSAMPLEDISTANCE = "surfMinsampledistance";
...
const std::string PBRT_SURFACEINTEGRATOR_PROP_FINALGATHERSAMPLES= "surfFinalgathersamples";    
const std::string PBRT_SURFACEINTEGRATOR_PROP_MINPIXELSPACING   = "surfMinpixelspacing";
const std::string PBRT_SURFACEINTEGRATOR_PROP_MAXPIXELSPACING   = "surfMaxpixelspacing";
const std::string PBRT_SURFACEINTEGRATOR_PROP_INDIRECTPHOTONS   = "surfIndirectphotons";
const std::string PBRT_SURFACEINTEGRATOR_PROP_ROUGHNESS         = "surfRoughness";
const std::string PBRT_SURFACEINTEGRATOR_PROP_MAXANGLEDIFFERENCE= "surfMaxangledifference";
...
const std::string PBRT_VOLUMEINTEGRATOR_PROP_VSDDATADIRECTORY   = "volVsddatadirectory";
