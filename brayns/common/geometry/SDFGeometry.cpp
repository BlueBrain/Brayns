...
namespace brayns
{
SDFGeometry createSDFSphere(const Vector3f &center, const float radius, const uint64_t data)
{
    SDFGeometry geom{};
    geom.userData = data;
...
SDFGeometry createSDFPill(const Vector3f &p0, const Vector3f &p1, const float radius, const uint64_t data)
{
    SDFGeometry geom{};
    geom.userData = data;
    geom.p0 = p0;
...
SDFGeometry
    createSDFConePill(const Vector3f &p0, const Vector3f &p1, const float r0, const float r1, const uint64_t data)
{
    SDFGeometry geom{};
    geom.userData = data;
    geom.p0 = p0;
