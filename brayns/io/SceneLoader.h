...
private:
    ...
    void _importMorphology(Model& model, MaterialManager& materialManager,
                           const Node& node, const Matrix4f& transformation);
#endif
    void _importMesh(Model& model, MeshLoader& loader,
                     MaterialManager& materialManager, const Node& node,
                     const Matrix4f& transformation);
    bool _processNodes(Model& model, MeshLoader& loader,
