...
namespace brayns
{
GetRendererParamsEntrypoint::GetRendererParamsEntrypoint(const Renderer &renderer)
    : GetPropertyObjectEntrypoint(renderer)
{
}
...
SetRendererParamsEntrypoint::SetRendererParamsEntrypoint(Renderer &renderer)
    : SetPropertyObjectEntrypoint(renderer)
{
}
