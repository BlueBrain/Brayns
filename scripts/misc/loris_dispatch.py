...
PATTERN = "/gpfs/bbp.cscs.ch/home/acfleury/src/Test/frames_test/%d.png"
...
with brayns.start(service, connector) as (process, instance):
    ...
    frames_per_node = math.ceil(frame_count / node_count)
    start = node_index * frames_per_node
    end = min(start + frames_per_node, frame_count)
