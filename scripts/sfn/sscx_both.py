...
PATH = "/gpfs/bbp.cscs.ch/project/proj64/circuits/S1.v6a/20171206/CircuitConfig"
...
def parse_circuit() -> Circuit:
    ...
    collection = cast(CellCollection, circuit.cells)

    cells = [int(cell) for cell in collection.ids()]
...
def load_model(
    ...
    loader = brayns.BbpLoader(
        cells=brayns.BbpCells.from_gids(cells),
