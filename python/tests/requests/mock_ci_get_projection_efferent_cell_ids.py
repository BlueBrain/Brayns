...
schema = {
    'async': False,
    'description': 'Return a list of efferent projected synapses cell GIDs from a circuit and a set of source cells',
    'params': [
        {
    ...
    'returns': {
        ...
        'title': 'CIGetProjectionEfferentCellIdsResult',
        'type': 'object'
    },
    'title': 'ci-get-projection-efferent-cell-ids',
    'type': 'method'
}
