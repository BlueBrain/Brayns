...
static const error_type SUCCESS = 0, OBJECT_MEMBER = 1, ARRAY_ELEMENT = 2,
                        ...
                        CORRUPTED_DOM = 9, TOO_DEEP_RECURSION = 10,
                        INVALID_ENUM = 11, CUSTOM = -1;
...
public:
    ...
    ParseStatus(ParseStatus&& other) noexcept : m_stack(), m_offset(), m_code()
    {
        swap(other);
    }
...
// For argument dependent lookup
inline void swap(ParseStatus& r1, ParseStatus& r2)
{
    r1.swap(r2);
}
}
