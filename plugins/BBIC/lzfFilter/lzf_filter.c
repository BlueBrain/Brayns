...
size_t lzf_filter(unsigned flags, size_t cd_nelmts, const unsigned cd_values[],
                  size_t nbytes, size_t* buf_size, void** buf);

herr_t lzf_set_local(hid_t dcpl, hid_t type);
...
#else
    H5Z_class_t filter_class = {(H5Z_filter_t)(H5PY_FILTER_LZF), "lzf", 0,
                                (H5Z_set_local_func_t)(lzf_set_local),
                                (H5Z_func_t)(lzf_filter)};
#endif
