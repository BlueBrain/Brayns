...
{
/**
 * @brief The NeuronColorHandler class provides functionality to set a vasculature node population circuit color
 */
class VasculatureColorData final : public CircuitColorData
{
public:
    VasculatureColorData(bbp::sonata::CircuitConfig config, std::string populationName);
