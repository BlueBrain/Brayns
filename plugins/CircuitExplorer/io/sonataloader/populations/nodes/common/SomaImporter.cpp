...
{
std::vector<CellCompartments> SomaImporter::import(const NodeLoadContext &ctxt, std::unique_ptr<IColorData> colorData)
{
    ...
    return SomaCircuitBuilder::load(context, model, std::move(colorData));
}
}
