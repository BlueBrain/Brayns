...
#include "BiophysicalColorData.h"
...
{
BiophysicalColorData::BiophysicalColorData(bbp::sonata::NodePopulation nodes)
    : _nodes(std::move(nodes))
{
}

std::vector<std::string> BiophysicalColorData::getMethods() const noexcept
{
...
std::vector<std::string> BiophysicalColorData::getMethodVariables(const std::string &method) const
{
...
std::vector<std::string> BiophysicalColorData::getMethodValuesForIDs(
