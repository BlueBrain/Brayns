...
{
/**
 * @brief IColorData implementation for point_neuron populations
 */
class PointNeuronColorData final : public IColorData
{
public:
    PointNeuronColorData(bbp::sonata::NodePopulation nodes);
