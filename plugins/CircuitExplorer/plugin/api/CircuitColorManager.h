...
public:
     ...
     * given ID
     */
    const std::vector<std::string> &getAvailableMethods(const brayns::ModelDescriptor &model);
     ...
     */
    const std::vector<std::string> &getMethodVariables(const brayns::ModelDescriptor &model, const std::string &method);
     ...
     */
    void updateColorsById(const brayns::ModelDescriptor &model, const std::vector<ColoringInformation> &vars);
     ...
     * associated
     */
    void updateColorsById(const brayns::ModelDescriptor &model, const std::map<uint64_t, brayns::Vector4f> &colorMap);
     ...
     * associated
     */
    void updateSingleColor(const brayns::ModelDescriptor &model, const brayns::Vector4f &color);
