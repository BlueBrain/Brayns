...
public:
    ...
    virtual void setColor(brayns::ModelDescriptor *model, const brayns::Vector4f &color) = 0;

protected:
    void _updateMaterial(brayns::ModelDescriptor *model, const size_t id, const brayns::Vector4f &color) const;
};
...
public:
     ...
     */
    void setElements(const std::vector<uint64_t> &ids, std::vector<ElementMaterialMap::Ptr> &&elements);
     ...
     */
    void updateColor(const std::string &method, const std::vector<ColoringInformation> &vars);
...
protected:
    ...
    virtual void _updateColorImpl(const std::string &method, const std::vector<ColoringInformation> &variables) = 0;
