...
BRAYNS_MESSAGE_BEGIN(SonataEdgePopulationParameters)
BRAYNS_MESSAGE_ENTRY(std::string, edge_population,
                     "Name of the edge population to load")
BRAYNS_MESSAGE_ENTRY(bool, load_afferent,
                     "Wether to load afferent or efferent edges")
BRAYNS_MESSAGE_ENTRY(float, edge_percentage,
...
BRAYNS_MESSAGE_BEGIN(SonataNodePopulationParameters)
BRAYNS_MESSAGE_ENTRY(std::string, node_population,
...
BRAYNS_MESSAGE_ENTRY(std::vector<uint64_t>, node_ids,
...
BRAYNS_MESSAGE_ENTRY(std::string, report_path,
                     ...
                     "is 'none' or 'spikes')")
BRAYNS_MESSAGE_ENTRY(std::vector<SonataEdgePopulationParameters>,
                     edge_populations,
...
BRAYNS_MESSAGE_ENTRY(VasculatureGeometrySettings,
...
BRAYNS_MESSAGE_BEGIN(SonataLoaderParameters)
BRAYNS_MESSAGE_ENTRY(std::vector<SonataNodePopulationParameters>,
