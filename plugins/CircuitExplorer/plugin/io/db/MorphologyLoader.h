...
using Sections = std::vector<morphio::Section>;
using SectionTypes = std::vector<morphio::SectionType>;
...
public:
     ...
     */
    void importMorphology(const brayns::PropertyMap& properties,
...
private:
     ...
     */
    float _getCorrectedRadius(const brayns::PropertyMap& properties,
    ...
    static const SectionTypes getSectionTypesFromProperties(
        const brayns::PropertyMap& properties);
