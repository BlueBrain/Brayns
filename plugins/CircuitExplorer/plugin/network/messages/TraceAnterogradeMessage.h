...
BRAYNS_JSON_OBJECT_ENTRY(size_t, model_id, "Model where to perform the neuronal tracing")
BRAYNS_JSON_OBJECT_ENTRY(std::vector<uint32_t>, cell_gids, "List of cell GIDs to use a source of the tracing")
